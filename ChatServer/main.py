...
def handle_send_message(data):
    ...
    print(f"Message sent from {sender_id} to {recipient_id}: {message}")
    emit('message', {'sender_id': "You", 'message': message}, room=recipient_id)
#    emit('message', {'sender_id': sender_id, 'message': message}, room=sender_id)  # Echo message back to sender
