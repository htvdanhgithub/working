...
def index():
    ...
    return render_template('index.html', num_languagues=len(map_languages), passed='no')
...
def signup():
    ...
    return render_template('index.html', email=email, num_languagues=len(map_languages), passed='yes')
